<template>
  <div>
    ...
    <div class="p-3 z-20 absolute h-auto w-80 bg-white left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
      ...
      <label class="block mt-5">email</label>
      ...
      <p><span class="float-left text-sm"><input type="checkbox"/> nasomye <span class="underline font-bold cursor-pointer">aya</span> mabwiriza, ndayemera</span></p>
      <div class="clear-both"></div>

      <button @click="register" class="w-full bg-green-800 rounded-lg text-white my-5 h-10 font-bold text-xl border-2 border-green-800 hover:text-green-800 hover:bg-white hover:border-green-800">IYANDIKISHE</button>
